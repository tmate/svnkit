...
import org.tmatesoft.svn.core.internal.wc.v17.SVNCommitClient17;
import org.tmatesoft.svn.core.internal.wc.v16.SVNCommitClient16;
...
public class SVNCommitClient extends SVNBasicClient {
    ...
    protected SVNCommitClient(SVNCommitClient from) {
        super(from);
        this.myCommitHandler = from.myCommitHandler;
        this.myCommitParameters = from.myCommitParameters;
    }
