...
import org.tmatesoft.svn.core.internal.wc.v17.SVNUpdateClient17;
import org.tmatesoft.svn.core.internal.wc.v16.SVNUpdateClient16;
...
public class SVNUpdateClient extends SVNBasicClient {
    ...
    protected boolean myIsUpdateLocksOnDemand;
    protected boolean myIsExportExpandsKeywords;

    protected SVNUpdateClient(SVNUpdateClient from) {
        super(from);
        this.myExternalsHandler = from.myExternalsHandler;
        this.myIsUpdateLocksOnDemand = from.myIsUpdateLocksOnDemand;
        this.myIsExportExpandsKeywords = from.myIsExportExpandsKeywords;
    }
