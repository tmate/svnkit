...
public class SVNMoveClient16 extends SVNMoveClient {
	protected SVNMoveClient dispatcher;

	protected SVNMoveClient16(SVNMoveClient from) {
		super(from);
		this.dispatcher = dispatcher;
	}

	public static SVNMoveClient16 delegate(SVNMoveClient dispatcher) {
		SVNMoveClient16 delegate = new SVNMoveClient16(dispatcher);
		return delegate;
	}
	...
	public void doMove(File src, File dst) throws SVNException {
		...
		if (!srcIsVersioned && !dstParentIsVersioned) {
			...
			try {
				...
				File srcWCRoot = SVNWCUtil16.getWorkingCopyRoot(src, true);
				File dstWCRoot = SVNWCUtil16.getWorkingCopyRoot(dst, true);
