...
public abstract class SVNAdminArea {
    ...
    public SVNEntry addEntry(String name) throws SVNException {
        ...
        SVNEntry entry = entries.containsKey(name) ? (SVNEntry) entries.get(name) : new SVNEntry(new SVNMap(), this, name);
