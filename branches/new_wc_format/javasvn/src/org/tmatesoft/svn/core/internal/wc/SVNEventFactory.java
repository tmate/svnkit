...
public class SVNEventFactory {
    ...
    public static SVNEvent createAddedEvent(SVNWCAccess source, SVNDirectory dir, SVNEntry entry) {
        ...
        try {
            mimeType = dir.getAdminArea(false).getPropertyValue(entry.getName(), false, SVNProperty.MIME_TYPE);//dir.getProperties(entry.getName(), false).getPropertyValue(SVNProperty.MIME_TYPE);
