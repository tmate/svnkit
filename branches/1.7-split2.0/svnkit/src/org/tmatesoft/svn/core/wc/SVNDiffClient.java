...
public class SVNDiffClient extends SVNBasicClient {
    ...
    public ISVNDiffGenerator getDiffGenerator() {
        if (getSVNDiffClient16().getDiffGenerator() == null) {
            setDiffGenerator(new DefaultSVNDiffGenerator());
        }
    ...
    public SVNDiffOptions getMergeOptions() {
        if (getSVNDiffClient16().getMergeOptions() == null) {
            setMergeOptions(new SVNDiffOptions());
        }
