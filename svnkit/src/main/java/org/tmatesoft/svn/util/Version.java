...
public class Version {
    ...
    private static final String VERSION_STRING_DEFAULT = "SVN/1.7.11 SVNKit/1.7.13 (http://svnkit.com/) rSNAPSHOT";
    
    private static final String VERSION_MAJOR_DEFAULT = "1";
    private static final String VERSION_MINOR_DEFAULT = "7";
    private static final String VERSION_MICRO_DEFAULT = "13";
    private static final String VERSION_REVISION_DEFAULT = "SNAPSHOT";
    private static final String SVN_VERSION_DEFAULT = "1.7.13";
