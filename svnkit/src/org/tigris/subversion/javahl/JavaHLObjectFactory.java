...
public class JavaHLObjectFactory {
    ...
    private static final Map STATUS_CONVERSION_MAP = new SVNMap();
    private static final Map REVISION_KIND_CONVERSION_MAP = new SVNMap();
    private static final Map ACTION_CONVERSION_MAP = new SVNMap();
    private static final Map LOCK_CONVERSION_MAP = new SVNMap();
    private static final Map CONFLICT_REASON_CONVERSATION_MAP = new SVNMap();
