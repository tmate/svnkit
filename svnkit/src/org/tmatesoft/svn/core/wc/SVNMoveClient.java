...
import org.tmatesoft.svn.core.internal.wc.v17.SVNMoveClient17;
import org.tmatesoft.svn.core.internal.wc.v16.SVNMoveClient16;
...
public class SVNMoveClient extends SVNCopyDriver {
    ...
    protected SVNWCClient myWCClient;
    protected SVNCopyClient myCopyClient;
    protected SVNMoveClient(SVNMoveClient from) {
        super(from);
        this.myWCClient = from.myWCClient;
        this.myCopyClient = from.myCopyClient;
    }
    /**
