...
public class SVNBasicClient16 extends SVNBasicClient implements
		ISVNEventHandler {
	protected SVNBasicClient dispatcher;

	protected SVNBasicClient16(SVNBasicClient from) {
		super(from);
		this.dispatcher = dispatcher;
	}

	public static SVNBasicClient16 delegate(SVNBasicClient dispatcher) {
		SVNBasicClient16 delegate = new SVNBasicClient16(dispatcher);
		return delegate;
	}
	 ...
	 */
	public SVNBasicClient16(ISVNRepositoryPool repositoryPool,
			ISVNOptions options) {
	 ...
	 * @from org.tmatesoft.svn.core.wc.SVNBasicClient
	 */
	public SVNBasicClient16(final ISVNAuthenticationManager authManager,
			ISVNOptions options) {
		this(new DefaultSVNRepositoryPool(authManager == null ? SVNWCUtil16
	...
	public void setOptions(ISVNOptions options) {
		myOptions = options;
		if (myOptions == null) {
			myOptions = SVNWCUtil16.createDefaultOptions(true);
		}
	}
		...
		if (pathPrefix != null) {
			eventHandler = new ISVNEventHandler() {
				...
				public void checkCancelled() throws SVNCancelException {
					SVNBasicClient16.this.checkCancelled();
				}
			};
		} else {
			eventHandler = this;
