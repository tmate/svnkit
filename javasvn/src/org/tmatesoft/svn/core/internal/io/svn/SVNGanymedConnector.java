    ...
    public void open(SVNRepositoryImpl repository) throws SVNException {
        ...
        while(true) {
            ...
            if (authentication == null) {
                SVNException.throwException(SVNErrorMessage.create(SVNErrorCode.CANCELLED));
            } else if (connection == null) {
                SVNException.throwException(SVNErrorMessage.create(SVNErrorCode.RA_SVN_CONNECTION_CLOSED, "Can not establish connection with to ''{0}''", realm));
            }
            try {
